...
Tài liệu này hướng dẫn cách lấy các biến môi trường cần thiết cho dự án krok-api.
...
- `database_name`: Tên database (ví dụ: `krok`)

**Ví dụ:**

```
DATABASE_URL="postgresql://postgres:mypassword@localhost:5432/krok"
```
...
- Nhập tên ứng dụng (ví dụ: "Krok API")
- Click "Generate"
...
# Production
CORS_ORIGIN="https://krok.com, https://admin.krok.com"
...
- Nhập username (ví dụ: `krok-api-user`)
...
```env
# Database
DATABASE_URL="postgresql://user:password@localhost:5432/krok"
